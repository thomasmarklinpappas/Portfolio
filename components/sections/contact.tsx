            ...
            <Container>
                <MotionUp delay={0.1}>
                    ...
                    <div className="flex sm:flex-nowrap flex-wrap mt-6 sm:mt-12">
                        <div
                            className="order-2 sm:order-1 w-full md:w-[60%]  rounded-lg overflow-hidden sm:mr-10 p-5 md:p-10 flex items-end justify-start relative dark:bg-gradient-to-br dark:from-black/70 dark:to-black/50 bg-gradient-to-br from-white/70 to-white/50"
                            style={{
                        ...
                        >
                            <div className="relative flex flex-wrap justify-center items-center w-full shadow-md">
                                <div className="w-full lg:w-1/2 px-6 mt-4">
                                    <h6 className="title-font font-semibold text-white tracking-widest text-xs">
                                        EMAIL
                                    </h6>
                                    <a
